            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tblLocations" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>RPO Office</th>
...
<script>
    $(function() {
        ...
        }).buttons().container().appendTo('#tblLocations_wrapper .col-md-6:eq(0)');

        // Add
        $("#addForm").submit(function(e) {
            e.preventDefault();
            $.post("process_locations.php", $(this).serialize(), function(res) {
