...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Rescheduled Applications</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <table id="applicationsTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $result = $conn->query("SELECT a.*, l.name as location, t.name as type FROM applications a LEFT JOIN locations l ON l.id = a.location LEFT JOIN types t ON t.id = a.type WHERE a.status = 'rescheduled' AND a.app_dt > '$now' ORDER BY a.app_dt ASC");
                                    $i = 0;
