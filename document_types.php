...
// Fetch data once for DataTable
$docs = $conn->query("SELECT * FROM document_names ORDER BY id DESC");
?>
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Manage Document Types</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="d-flex justify-content-between">
                        <h3 class="m-0">Document Types</h3>
...
<script>
    $(function() {
        ...
        $("#addForm").submit(function(e) {
            e.preventDefault();
            $.post("process_documents.php", $(this).serialize(), function(res) {
